            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end p-4 text-center" style="width: 300px !important;">
                    ...
                    <div class="text-start">
                        <p>Username: tester</p>
                        <p>Email: test@testing.comocom</p>
                        <p>User since: 2023-03-27 23:08:14</p>
                    </div>
                    <button class="btn w-100" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right mb-1" viewBox="0 0 16 16">
