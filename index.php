        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end p-4 text-center" style="width: 300px !important;">
                    ...
                    <button class="btn w-100 mt-1" id="logout" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right mb-1 me-1" viewBox="0 0 16 16">
